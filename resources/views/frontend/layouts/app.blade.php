...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('website/assests/css/about.css') }}">
    <link rel="stylesheet" href="{{ asset('website/assests/css/contact.css') }}">
    <link rel="icon" type="image/x-icon" href="{{ asset('website/assests/image/log.png') }}">
    @stack('header')
...
<body>
    ...
    @yield('content')
    <!-- Foteer Section Styling  -->
    <footer>
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-3">
                        <img src="{{ asset('website/assests/image/log.png') }}" alt alt="Logo" class="me-2 rounded "
                            style="height: 100px; width:100px; margin-top: 10px;">

                    </div>
                    <p class="text-muted pe-lg-5">
                        Empowering minds, shaping futures. Committed to delivering excellence in world-class
                        education
                        and fostering global innovation.
                    </p>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <h5 class="mb-4 fw-bold" style="margin-top:10px">Connect With Us</h5>
                    ...
                    <p class="small text-muted">Stay updated with our latest news and events.</p>
                </div>
            </div>
            ...
            <div class="footer-bottom mt-5">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        © 2026 Collegesagar. All rights reserved.
                    </div>
                    <div class="col-md-6 text-center text-md-end bottom-links">
