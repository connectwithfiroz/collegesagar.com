                        ...
                        <form id="proScholarshipForm" action="/submit-form" method="POST">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="college" id="collegeInput"
                                    placeholder="College Name" readonly value="{{ $college->name }}" />
                                <label for="collegeInput">Campus / College / Course</label>
                            </div>
                                ...
                                <div class="col-6">
                                    <div class="form-floating">
                                        <select class="form-select" name="course" id="courseSelect" required>
                                            ...
                                            @foreach($collegeCourses as $cl_course)
                                                @if(!empty($cl_course['course']))
                                                <option value="{{ $cl_course['course'] }} {{ $cl_course['specialization'] ?? '' }}">
                                                    {{ $cl_course['course'] }} -
                                                    {{ $cl_course['specialization'] ?? '' }}
                                                </option>
                                                @endif
                                            @endforeach
                            ...
                            <div class="form-floating mb-4">
                                <textarea class="form-control" name="message" id="message" style="height: 100px"
                                    placeholder="Career Goal"></textarea>
                                <label>Career Ambition</label>
                            </div>

                            <button type="submit" class="btn btn-submit w-100 mb-3 shadow">
                                Submit Application
                            </button>
